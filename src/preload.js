...
contextBridge.exposeInMainWorld('espn', {
  ...
  getMatchups: (leagueId, scoringPeriodId) =>
    ipcRenderer.invoke('espn:getMatchups', { leagueId, scoringPeriodId }),
  getRoster: (leagueId, teamId, scoringPeriodId) =>
    ipcRenderer.invoke('espn:getRoster', { leagueId, teamId, scoringPeriodId })
});
